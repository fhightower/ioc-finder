...
IOC_EXAMPLES = {
    ...
    'sha1s': ['a' * 40],
    'md5s': ['a' * 32],
    'ssdeeps': ['12288:QYV6MorX7qzuC3QHO9FQVHPF51jgcSj2EtPo/V7I6R+Lqaw8i6hG0:vBXu9HGaVHh4Po/VU6RkqaQ6F', '0000:0000:ff00', '2001:0db8:0000'],  # I don't like that the components of an ipv6 can be parsed as an ssdeep... I've ticketed this here: https://github.com/fhightower/ioc-finder/issues/228
    'asns': ['ASN123'],
    'cves': ['CVE-2022-1234'],
    ...
    'user_agents': ['Mozilla/4.0 (compatible; MSIE 7.0b; Windows NT 5.1; .NET CLR 1.1.4322; InfoPath.1) TLP'],  # I don't like this parsing... I've ticketed this for improvement here: https://github.com/fhightower/ioc-finder/issues/227
    'tlp_labels': ['TLP:RED'],
    'mac_addresses': ['AA-F2-C9-A6-B3-4F'],
